...
! function(t) {
    ...
    function vt(t) {
        ...
        if (f && f.useFirstGroupAsInitialState) {
            ...
            l.forEach(function(t) {
                var i, o = t.config,
                    a = t.actionTypeId,
                    u = (null == o ? void 0 : null === (i = o.target) || void 0 === i ? void 0 : i.useEventTarget) ? {
                        target: c.target,
                        targets: c.targets
                    } : o,
                    s = C({
    ...
    var f = s(n(250)),
        ...
        dt = Object.freeze((i = {}, (0, c.default)(i, _.TRANSFORM_PREFIXED, I), (0, c.default)(i, P, m), (0, c.default)(i, x, x), (0, c.default)(i, C, C), (0, c.default)(i, L, L), (0, c.default)(i, D, D), i)),
        pt = {},
        vt = 1;
    var ht = 1;
    var Et = function(t, e) {
        ...
        T = function(t, e) {
            ...
            if (E && !g)
                for (var D = 0, P = a.length; D < P; D++) {
                    ...
                    for (var j = (O - _) / m, F = E.config.easing, G = h(F, j, f), X = 0, k = a.length; X < k; X++) {
                        var V = a[X],
                            U = y(s, V, E.config),
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function m(e, n) {
            ...
            i.handler = null, i.redirect = r.attr("data-redirect"), _.test(u) ? i.handler = A : u || (o ? i.handler = b : y())
        }
